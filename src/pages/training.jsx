...
const Page = () => (
    <MarginStyle>
        <MainStyle>
            ...
            <p><a href="struktura-i-organy-upravleniya-obrazovatel'noj-organizaciej.html">Структура и органы управления
            ...
            <p><a href="rukovodstvo-pedagogicheskij-sostav.html">Руководство Педагогический (научно-педагогический)
                состав</a></p>
            <p><a href="download/mto.pdf">Материально-техническое обеспечение и оснащенность образовательного
                процесса</a></p>
            <p><a href="stipendii-i-inye-vidy-material'noj-podderzhki.html">Стипендии и иные виды материальной
                поддержки</a></p>
